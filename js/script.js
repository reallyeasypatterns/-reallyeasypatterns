...
$(document).ready(function() {
    ...
    var patternData = [
        ...
        { en: "It's time to ~", kr: "~할 시간이야", url: "lesson_011.html" },
        { en: "Are you sure ~?", kr: "정말 ~야? (확실해?)", url: "lesson_012.html" },
        ...
        { en: "When do you ~?", kr: "너 언제 ~해?", url: "lesson_021.html" },
        { en: "Why did you ~?", kr: "너 왜 ~했어?", url: "lesson_022.html" },
        { en: "I'd like to ~", kr: "~하고 싶습니다", url: "lesson_023.html" },
        { en: "You should ~", kr: "너 ~하는 게 좋겠어 (해야 해)", url: "lesson_024.html" },
        { en: "Would you like ~?", kr: "~하시겠어요? (~ 원하세요?)", url: "lesson_025.html" },
        { en: "I think I should ~", kr: "나 ~해야 할 것 같아", url: "lesson_026.html" },
        { en: "I used to ~", kr: "나 예전에 ~하곤 했어", url: "lesson_027.html" },
...
$(document).ready(function() {
    ...
    var quizPatternData = [
        ...
        { en: "It's time to ~", kr: "~할 시간이야", json: "../data/rep011_sentences.json" },
        { en: "Are you sure ~?", kr: "정말 ~야? (확실해?)", json: "../data/rep012_sentences.json" },
        ...
        { en: "When do you ~?", kr: "너 언제 ~해?", json: "../data/rep021_sentences.json" },
        { en: "Why did you ~?", kr: "너 왜 ~했어?", json: "../data/rep022_sentences.json" },
        { en: "I'd like to ~", kr: "~하고 싶습니다", json: "../data/rep023_sentences.json" },
        { en: "You should ~", kr: "너 ~하는 게 좋겠어 (해야 해)", json: "../data/rep024_sentences.json" },
        { en: "Would you like ~?", kr: "~하시겠어요? (~ 원하세요?)", json: "../data/rep025_sentences.json" },
        { en: "I think I should ~", kr: "나 ~해야 할 것 같아", json: "../data/rep026_sentences.json" },
        { en: "I used to ~", kr: "나 예전에 ~하곤 했어", json: "../data/rep027_sentences.json" },
